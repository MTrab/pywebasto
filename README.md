...
you want a custom name/version there, pass a short text with three parts. The
first part is shown as the name, the second as the version, and the third must
be an integer stamp:
